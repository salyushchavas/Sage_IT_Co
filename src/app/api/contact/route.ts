  ...
  try {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a1a; color: #e4e4e7; padding: 32px; border-radius: 16px;">
          <div style="text-align: center; margin-bottom: 24px;">
            <h1 style="color: #0F5132; margin: 0; font-size: 24px;">New Contact Inquiry</h1>
          ...
          <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
            ...
            <tr>
              ...
              <td style="padding: 12px 16px; border-bottom: 1px solid #27272a; color: #0F5132; font-size: 14px;">
                <a href="mailto:${email}" style="color: #0F5132; text-decoration: none;">${email}</a>
              </td>
            </tr>
            ${company ? `
            <tr>
            ...
            <tr>
              ...
              <td style="padding: 12px 16px; border-bottom: 1px solid #27272a; color: #D4A017; font-size: 14px;">${service}</td>
            </tr>
            ` : ""}
          </table>
    ...
    const confirmationOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a1a; color: #e4e4e7; padding: 32px; border-radius: 16px;">
          <div style="text-align: center; margin-bottom: 24px;">
            <h1 style="color: #0F5132; margin: 0; font-size: 24px;">Thank You, ${firstName}!</h1>
          </div>
          ...
          <p style="color: #a1a1aa; font-size: 14px; line-height: 1.7;">
            In the meantime, feel free to explore our <a href="https://sageitco.com/services" style="color: #0F5132; text-decoration: none;">services</a>
            or check out our <a href="https://sageitco.com/portfolio" style="color: #0F5132; text-decoration: none;">portfolio</a>.
          </p>

          <div style="text-align: center; margin-top: 24px; padding-top: 16px; border-top: 1px solid #27272a;">
            <p style="color: #D4A017; font-weight: 600; font-size: 16px; margin: 0;">Sage IT</p>
