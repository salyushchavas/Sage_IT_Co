  ...
  try {
          ...
          <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
            ...
            <tr>
              ...
              <td style="padding: 12px 16px; border-bottom: 1px solid #27272a; color: #1B2A5C; font-size: 14px;">
                <a href="mailto:${email}" style="color: #1B2A5C; text-decoration: none;">${email}</a>
              </td>
            </tr>
            ${company ? `
            <tr>
            ...
            <tr>
              ...
              <td style="padding: 12px 16px; border-bottom: 1px solid #27272a; color: #C87D5C; font-size: 14px;">${service}</td>
            </tr>
            ` : ""}
          </table>
    ...
    const confirmationOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a1a; color: #e4e4e7; padding: 32px; border-radius: 16px;">
          <div style="text-align: center; margin-bottom: 24px;">
            <h1 style="color: #1B2A5C; margin: 0; font-size: 24px;">Thank You, ${firstName}!</h1>
          </div>
