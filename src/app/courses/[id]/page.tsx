  ...
  if (error || !course) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen pt-24 px-6">
        ...
        <Link href="/courses" className="text-[#1B2A5C] hover:underline text-sm">Back to courses</Link>
      </div>
    );
  }
  ...
  return (
    <section className="min-h-screen pt-28 pb-20 px-6">
      <div className="mx-auto max-w-5xl">
        {/* Back */}
        <Link href="/courses" className="inline-flex items-center gap-1 text-sm text-zinc-500 hover:text-[#1B2A5C] mb-6 transition-colors">
          ...
          <div className="lg:col-span-2">
            ...
            {course.instructor && (
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#C87D5C] to-[#1B2A5C] flex items-center justify-center text-sm font-bold text-zinc-900">
          ...
          <div className="bg-white/60 backdrop-blur-xl border border-zinc-200 rounded-2xl p-6">
            ...
            <button
              ...
              className={cn(
                ...
                "btn-fill text-white",
                "hover:shadow-[0_0_30px_rgba(27,42,92,0.3)] hover:scale-[1.02]",
                "disabled:opacity-50"
              )}
            >
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
          <div className="flex items-center justify-between mb-6">
            ...
            {canManage && (
              <button onClick={() => setShowAddLesson(!showAddLesson)} className="flex items-center gap-1.5 text-sm font-medium text-[#1B2A5C] hover:text-[#0F1F44] transition-colors">
          ...
          {showAddLesson && canManage && (
            ...
            >
              <input type="text" placeholder="Lesson title *" required value={newLesson.title}
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-white/60 border border-zinc-200 text-zinc-900 text-sm placeholder-zinc-400 outline-none focus:border-[#1B2A5C]/40" />
              ...
              <div className="grid grid-cols-2 gap-4">
                <input type="url" placeholder="Video URL (optional)" value={newLesson.videoUrl}
                  ...
                  className="px-4 py-2.5 rounded-xl bg-white/60 border border-zinc-200 text-zinc-900 text-sm placeholder-zinc-400 outline-none focus:border-[#1B2A5C]/40" />
                ...
                return (
                  ...
                  >
                    <div className="bg-white/60 backdrop-blur-xl border border-zinc-200 rounded-2xl overflow-hidden">
                      ...
                      >
                        <div className="w-8 h-8 rounded-lg bg-[#1B2A5C]/10 border border-[#1B2A5C]/20 flex items-center justify-center text-xs font-bold text-[#1B2A5C] shrink-0">
                          {idx + 1}
                        </div>
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-3 text-xs text-zinc-500 mt-0.5">
                            ...
                            {lesson.isFree && <span className="text-[#0F1F44]">Free</span>}
                          </div>
                        </div>
                        {canManage && (
                          <button
                        ...
                        <div className="px-4 pb-4 space-y-3 border-t border-zinc-200 pt-3">
                          ...
                          {enrolled && !canManage && (
                            <button
                              ...
                              className="text-xs text-[#1B2A5C] hover:underline"
                            >
                              Mark as complete
                            </button>
                          )}
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="mt-12">
            ...
            <div className="space-y-3">
              {assignments.map((a, idx) => (
                ...
                >
                  <div className="w-8 h-8 rounded-lg bg-[#C87D5C]/10 border border-[#C87D5C]/20 flex items-center justify-center shrink-0">
                    <ClipboardList className="w-4 h-4 text-[#C87D5C]" />
                  </div>
        ...
        {enrolled && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="mt-12">
            <div className="bg-white/60 backdrop-blur-xl border border-zinc-200 rounded-2xl p-8 text-center">
              <Award className="w-10 h-10 text-[#1B2A5C] mx-auto mb-3" />
              ...
              {certificate?.exists && certificate.certificateUrl ? (
                <>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 rounded-xl btn-fill text-white text-sm font-semibold hover:shadow-[0_0_20px_rgba(27,42,92,0.3)] transition"
                  >
                ...
                <>
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 rounded-xl btn-fill text-white text-sm font-semibold hover:shadow-[0_0_20px_rgba(200,125,92,0.3)] transition disabled:opacity-50"
                  >
