  ...
  if (error || !course) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen pt-24 px-6">
        ...
        <Link href="/courses" className="text-[#0F5132] hover:underline text-sm">Back to courses</Link>
      </div>
    );
  }
  ...
  return (
    <section className="min-h-screen pt-28 pb-20 px-6">
      <div className="mx-auto max-w-5xl">
        {/* Back */}
        <Link href="/courses" className="inline-flex items-center gap-1 text-sm text-zinc-500 hover:text-[#0F5132] mb-6 transition-colors">
          ...
          <div className="lg:col-span-2">
            ...
            {course.instructor && (
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#D4A017] to-[#0F5132] flex items-center justify-center text-sm font-bold text-zinc-900">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
          <div className="flex items-center justify-between mb-6">
            ...
            {canManage && (
              <button onClick={() => setShowAddLesson(!showAddLesson)} className="flex items-center gap-1.5 text-sm font-medium text-[#0F5132] hover:text-[#0A3D26] transition-colors">
          ...
          {showAddLesson && canManage && (
            ...
            >
              <input type="text" placeholder="Lesson title *" required value={newLesson.title}
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-white/60 border border-zinc-200 text-zinc-900 text-sm placeholder-zinc-400 outline-none focus:border-[#0F5132]/40" />
              ...
              <div className="grid grid-cols-2 gap-4">
                <input type="url" placeholder="Video URL (optional)" value={newLesson.videoUrl}
                  ...
                  className="px-4 py-2.5 rounded-xl bg-white/60 border border-zinc-200 text-zinc-900 text-sm placeholder-zinc-400 outline-none focus:border-[#0F5132]/40" />
                ...
                return (
                  ...
                  >
                    <div className="bg-white/60 backdrop-blur-xl border border-zinc-200 rounded-2xl overflow-hidden">
                      ...
                      >
                        <div className="w-8 h-8 rounded-lg bg-[#0F5132]/10 border border-[#0F5132]/20 flex items-center justify-center text-xs font-bold text-[#0F5132] shrink-0">
                          {idx + 1}
                        </div>
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-3 text-xs text-zinc-500 mt-0.5">
                            ...
                            {lesson.isFree && <span className="text-[#0A3D26]">Free</span>}
                          </div>
                        </div>
                        {canManage && (
                          <button
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="mt-12">
            ...
            <div className="space-y-3">
              {assignments.map((a, idx) => (
                ...
                >
                  <div className="w-8 h-8 rounded-lg bg-[#D4A017]/10 border border-[#D4A017]/20 flex items-center justify-center shrink-0">
                    <ClipboardList className="w-4 h-4 text-[#D4A017]" />
                  </div>
        ...
        {enrolled && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="mt-12">
            <div className="bg-white/60 backdrop-blur-xl border border-zinc-200 rounded-2xl p-8 text-center">
              <Award className="w-10 h-10 text-[#0F5132] mx-auto mb-3" />
