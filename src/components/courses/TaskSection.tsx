  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <ListTodo className="w-5 h-5 text-[#0F1F44]" />
              ...
              <div className="flex-shrink-0">
                {task.completed ? (
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg bg-[#1B2A5C]/10 border border-[#1B2A5C]/20 text-[#1B2A5C] text-xs font-medium hover:bg-[#1B2A5C]/20 transition-colors disabled:opacity-50"
                  >
