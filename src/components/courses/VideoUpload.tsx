  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="border-2 border-dashed border-white/10 rounded-xl p-8 text-center cursor-pointer hover:border-[#00d4ff]/30 transition-colors"
      >
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#7c3aed] to-[#00d4ff] text-white font-medium text-sm hover:opacity-90 transition-opacity disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-2"
        >
          {uploading ? (
            <>
