...
public class AgreementUser {
    ...
    /**
     * Console sign-ins issued before this moment (epoch milliseconds) no
     * longer work: set when the account is disabled, its password is reset
     * or its role changes. Null: no cut-off.
     */
